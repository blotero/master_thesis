...
\begin{tabular}{lcccc}\toprule
  \textbf{Characteristic} & \textbf{KAAR} \cite{GilGonzalezEtAl2018}
  & \textbf{LKAAR} \cite{GilGonzalezEtAl2021} &
  \textbf{RCDNN} \cite{GilGonzalezEtAl2021-RCDNN} & \textbf{CGP}
  \cite{GilEtAlvarez2023CCGPMA} \\\midrule
...
data and the relationships between annotators. Several considerations
...
segmentation presents significant computational challenges. The cubic
...
a data point. This limitation makes traditional GP approaches
...
capabilities that GPs naturally provide.
