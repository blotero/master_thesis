...
\newacronym{KAAR}{KAAR}{Kernel Alignment-Based Annotator Relevance Analysis}
\newacronym{RCDNN}{RCDNN}{Regularized Chained Deep Neural Network}
\newacronym{LKAAR}{LKAAR}{Localized Kernel Alignment-Based Annotator
Relevance Analysis}

\newacronym{GPR}{GPR}{Gaussian Process Regression}
\newacronym{GPMC}{GPMC}{Gaussian Process Monte Carlo}
\newacronym{SGPR}{SGPR}{Sparse Gaussian Process Regression}
\newacronym{SGPMC}{SGPMC}{Sparse Gaussian Process Monte Carlo}
