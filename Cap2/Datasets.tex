...
For these reasons, multiple datasets were created this work in the pursuit of
...
satisfactory performance was achieved, the focus was shifted to
histopathology images and further tunings on the models
...
important biomarkers such as ER (Estrogen Receptor), PGR (Progesterone
Receptor), HER2 (Human Epidermal Growth Factor Receptor 2), and KI67
(Ki67 Proliferation Marker), which are routinely used in breast cancer
diagnosis and treatment planning (more on staining techniques in
Section \ref{sec:staining-techniques}).

The dataset's relevance to our work stems from several key aspects.
The matched H\&E and IHC stains allows for studying the consistency of
...
KI67) enable to study how different tissue characteristics affect
...
resulting in over 20,000 annotated tissue regions. The annotation efforts
are focused on \gls{TNBC}, an aggressive genomic subtype that comprises
~15\% of breast cancer cases \cite{PlasilovaEtAl2016}.
