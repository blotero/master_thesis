...
\cite{Panayides2020}. One of the most common tasks in which machine
learning technologies are being used in the universe of medical images
is \gls{ISS}, which consists of assigning a label to each pixel in an image
according to the object it belongs to. This is crucial for the development
...
significantly, including classification, segmentation,
...
based on counted referenced terms occurrences from recent literature
review, can be seen in Figure \ref{fig:medical_image_analysis}.
\cite{YuEtAl2025}, \cite{BritoPacheco2025}, \cite{RyouEtAl2025},
\cite{DingyiEtAl2025}, \cite{BehnazEtAl2025}

\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{Cap1/Figures/comparative-tasks-and-medical-image-types.png}
...
Throughout the time that medical images and computational techniques
have been developed, a coevolution has occurred, where the complexity
of the tasks and the capabilities of the computational techniques
have been increasing \cite{Zhou2021}. Initially, these needs were covered
with simple morphological transformations, which implied no training process or
elaborated optimization, this is an advantage in terms of development costs but
has limited performance. However, as the complexity of the tasks
...
\cite{Shalf2020}. Figure \ref{fig:medical-ai-timeline} shows a
...
\begin{figure}
  ...
  0},width=\textwidth]{Cap1/Figures/medical-ai-timeline.png}
  \caption{AI and Machine Learning in medical imaging recent timeline.}
  \label{fig:medical-ai-timeline}
\end{figure}

\gls{CNN} have been widely used in \gls{SS}, as they have outperformed
traditional Machine Learning algorithms both medical
and non medical images \cite{XuYan2024} \cite{Sarvamangala2022}.
However, most \gls{CNN} architectures are deep, which introduces
the requirement of large amounts of training data. This introduces
a problem since the acquisition and annotation of medical images
...
is taxing in terms of cost, time and the logistics involved
\cite{Bhalgat2018}. Other modalities face this problem through less expensive
...
However, many medical images datasets contain a high variability in
...
staining techniques and other factors which can affect the color of the images
...
is the \textit{crowdsourcing} strategy, which consists of having multiple
annotators labeling the same image, and then combining the labels to obtain
a consensus label \cite{LuEtAl2023}. This strategy can lead to a
...
the latter being less expensive to hire \cite{Lopez2023}.
...
leading to inconsistencies among annotators \cite{Lopez2023}.
Because of this, crowdsourcing labeling is one of the most popular
approaches, as illustrated in Figure \ref{fig:multiannotator_segmentation},
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{Cap1/Figures/multiannotator-segmentation.png}
