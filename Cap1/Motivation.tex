...
% Faltan dos párrafos: el primero debe dar contexto de histologias,
% su impacto en el tratamiento de cancer y su diagnostico y
% seguimiento desde segmentacion de imagenes, etiquetadas por varios anotadores.
%El segundo, debe concluir el contexto de multiples anotadores en
% segmentacion de imagenes, referenciando un dibujo ilustrativo, una
% misma imagen segmentada por varios expertos. La ultima frase de ese
% parrafo debe concluir que es necesario seguir generando
% aproximaciones de IA que permitan trabajar en contextos
% crowdsorcing en segmentacion de imagen, con particular interes, en
% lo referente a histologias
